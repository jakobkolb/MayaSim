#!/bin/bash
#SBATCH --qos=short
#SBATCH --job-name=X1_comp
#SBATCH --account=copan
#SBATCH --output=X1_comp_%A_%a.out
#SBATCH --error=X1_comp_%A_%a.err
...
mpirun -n $SLURM_NTASKS python X1_aggregate_dynamics.py --mode 0 --job_id $SLURM_ARRAY_TASK_ID --max_id $SLURM_ARRAY_TASK_MAX
